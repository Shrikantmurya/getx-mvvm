  ...
  final Widget? mobile;
   AdaptiveScreen({
    ...
    this.mobile,
      ...
      final rWidth = MediaQueryData.fromView(WidgetsBinding.instance.window).size.width;
      final rHeight = MediaQueryData.fromView(WidgetsBinding.instance.window).size.height;
  @override
